...
const categoryConfig: Record<string, {
  ...
  keychain: {
    ...
    description: 'アクリルキーホルダー・ラバーキーホルダーのOEM製作。小ロット10個〜対応、高品質フルカラー印刷。同人グッズ・ノベルティ・推し活グッズに最適。格安・スピード納品。',
    keywords: [
  ...
  packaging: {
    name: 'パッケージ',
    title: 'パッケージ・袋製作・OEM | オリジナルビニール袋・レジ袋',
    description: 'オリジナルビニール袋・レジ袋のOEM製作。企業ロゴ・デザインをフルカラー印刷。店舗・イベント・物販に最適。小ロット対応。',
    keywords: [
      'ビニール袋 製作', 'ビニール袋 オリジナル', 'ビニール袋 OEM',
      'レジ袋 オリジナル', 'レジ袋 製作', 'レジ袋 印刷',
      'ショッパー 製作', 'オリジナル袋', 'パッケージ OEM',
      '包装 オリジナル', '袋 名入れ', '店舗 袋',
    ],
    heading: 'パッケージ・袋製作',
    seoText: 'FAST OEMでは、オリジナルのビニール袋・レジ袋をOEM製作しています。企業ロゴやオリジナルデザインをフルカラーで印刷可能。店舗での商品包装、イベントでのグッズ配布、物販での袋詰めなどに最適です。ブランドイメージの統一や、来店者への印象づけに効果的です。',
  },
}
