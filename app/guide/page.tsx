...
const pricingData = [
  {
    name: 'アクリルキーホルダー',
    ranges: [
      { qty: '50個〜', price: '¥75〜94/個' },
      { qty: '200個〜', price: '¥70〜89/個' },
      { qty: '1,000個〜', price: '¥63〜82/個' },
    ],
  },
  {
    name: '缶バッジ',
    ranges: [
      { qty: '100個〜', price: '¥115〜127/個' },
      { qty: '500個〜', price: '¥51〜63/個' },
      { qty: '1,000個〜', price: '¥29〜41/個' },
    ],
  },
  {
    name: 'ピンバッジ',
    ranges: [
      { qty: '50個〜', price: '¥60〜204/個' },
      { qty: '200個〜', price: '¥55〜199/個' },
      { qty: '1,000個〜', price: '¥52〜196/個' },
    ],
  },
  {
    name: 'ラバーキーホルダー',
    ranges: [
      { qty: '50個〜', price: '¥72〜91/個' },
      { qty: '200個〜', price: '¥68〜87/個' },
      { qty: '1,000個〜', price: '¥60〜79/個' },
    ],
  },
]
...
const faqItems = [
  {
    ...
    a: '商品や数量によって異なりますが、通常2週間〜1ヶ月程度です。特急オプション（約2週間・送料2倍）もご用意しておりますので、お急ぎの場合もご相談ください。',
  },
  {
            ...
            <div className="bg-muted/30 rounded-2xl p-8 md:p-10">
              ...
              <div className="text-foreground/80 leading-relaxed space-y-4">
                ...
                <p>
                  ...
                  小ロット50個から対応しているため、個人クリエイターの方でも気軽にグッズ制作を始められます。
