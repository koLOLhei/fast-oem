...
// 2026-04 価格改訂に合わせて更新。サイズ指定による multiplier を加味した
// 最小〜最大レンジ（税抜/個）。正確な単価は商品ページで自動計算。
const pricingData = [
  {
    name: 'アクリルキーホルダー',
    ranges: [
      { qty: '50個〜', price: '¥144〜432/個' },
      { qty: '500個〜', price: '¥108〜324/個' },
      { qty: '1,000個〜', price: '¥96〜288/個' },
      { qty: '10,000個〜', price: '¥66〜197/個' },
    ],
  },
  {
    name: '缶バッジ',
    ranges: [
      { qty: '100個〜', price: '¥62〜162/個' },
      { qty: '500個〜', price: '¥47〜122/個' },
      { qty: '1,000個〜', price: '¥42〜111/個' },
      { qty: '10,000個〜', price: '¥31〜82/個' },
    ],
  },
  {
    name: 'ピンバッジ',
    ranges: [
      { qty: '50個〜（金型代別途）', price: '¥196〜490/個' },
      { qty: '500個〜', price: '¥140〜350/個' },
      { qty: '1,000個〜', price: '¥126〜315/個' },
      { qty: '10,000個〜', price: '¥90〜224/個' },
    ],
  },
  {
    name: 'ラバーキーホルダー',
    ranges: [
      { qty: '50個〜（金型代別途）', price: '¥136〜408/個' },
      { qty: '500個〜', price: '¥100〜300/個' },
      { qty: '1,000個〜', price: '¥88〜264/個' },
      { qty: '10,000個〜', price: '¥60〜180/個' },
    ],
  },
]
...
const faqItems = [
  {
    ...
    a: 'ご入金確認後15〜30営業日（目安3〜4週間）が通常納期です。特急オプション（12営業日以内・送料2倍）もご用意しておりますので、お急ぎの場合もご相談ください。',
  },
  {
  ...
  {
    q: '小ロット（少量）でも注文できますか？',
    a: 'もちろんです。アクリルキーホルダー・ピンバッジ・ラバーキーホルダーは50個から、缶バッジは100個からご注文いただけます。個人の方から法人の方まで幅広くご利用いただいています。',
  },
  {
    q: 'サンプル（試作品）は作れますか？',
...
const howToJsonLd = {
  ...
  step: [
    ...
    },
    {
      ...
      position: 4,
      name: '商品を受け取る',
      text: '製造完了後、指定住所へ配送します。通常15〜30営業日（目安3〜4週間）でお届けします。',
    },
  ],
}
            ...
            <div className="bg-muted/30 rounded-2xl p-8 md:p-10">
              ...
              <div className="text-foreground/80 leading-relaxed space-y-4">
                ...
                <p>
                  ...
                  小ロット50個（缶バッジは100個）から対応（缶バッジは100個〜）しているため、個人クリエイターの方でも気軽にグッズ制作を始められます。
                  提携工場で高品質な製造を行い、通常15〜30営業日（目安3〜4週間）でお届けします。
                </p>
              </div>
            </div>
          </section>
