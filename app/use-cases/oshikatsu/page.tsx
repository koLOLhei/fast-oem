...
export const metadata: Metadata = {
  ...
  description:
    '推し活グッズの製作ならFAST OEM。推しの写真やイラストでアクリルキーホルダー・缶バッジ・ピンバッジを作成。小ロット50個〜対応（缶バッジは100個〜）。ライブ・イベント・布教用に。高品質フルカラー印刷。',
  openGraph: {
    title: '推し活グッズ製作 | FAST OEM',
    description: '推し活グッズの製作ならFAST OEM。推しの写真やイラストでオリジナルグッズを作成。小ロット50個〜（缶バッジは100個〜）。',
...
const benefits = [
  ...
  { icon: Package, title: '小ロット50個〜OK（缶バッジは100個〜）', description: '友達と分け合うぶんだけ作れる。在庫を抱える心配なし。' },
  { icon: Palette, title: 'かんたんデザイン入稿', description: '画像をアップロードするだけ。デザインソフト不要で簡単に作成できます。' },
  { icon: Zap, title: '特急12営業日以内でお届け', description: 'ライブやイベントに間に合う特急オプション（12営業日以内）対応。通常も15〜30営業日で届きます。' },
]
...
export default async function OshikatsuPage() {
  ...
  const serviceJsonLd = {
    ...
    '@type': 'Service',
    name: '推し活グッズ製作サービス',
    description: '推し活向けオリジナルグッズのOEM製作。アクリルキーホルダー・缶バッジ・ラバーキーホルダーを小ロット50個（缶バッジは100個）から。',
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center">
              ...
              <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                ...
                アクリルキーホルダー・缶バッジ・ラバーキーホルダーが小ロット50個（缶バッジは100個）から作れます。
              </p>
        ...
        <section className="py-16 bg-muted/20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-sm text-muted-foreground space-y-4 leading-relaxed">
              ...
              <p>
                FAST OEMでは、推しの写真やイラストを使ったアクリルキーホルダー・缶バッジ・ラバーキーホルダーを、小ロット50個（缶バッジは100個）から製作できます。
