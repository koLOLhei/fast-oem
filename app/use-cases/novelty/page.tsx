...
export const metadata: Metadata = {
  ...
  keywords: [
    'ノベルティ 製作', 'ノベルティ 作成', 'ノベルティグッズ', 'ノベルティグッズ 製作',
    '企業 ノベルティ', '販促グッズ', '販促グッズ 製作', '販促品 オリジナル',
    '展示会 グッズ', '展示会 ノベルティ', 'キャンペーン グッズ',
    '企業ロゴ グッズ', 'オリジナルノベルティ', '記念品 製作',
    'ノベルティ 小ロット', 'ノベルティ OEM',
  ],
  openGraph: {
...
const benefits = [
  ...
  { icon: Truck, title: '柔軟な納期対応', description: '通常2〜3週間、特急約10日。展示会・イベントの日程に合わせてスケジュール調整可能。' },
