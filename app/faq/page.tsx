...
const faqCategories = [
  ...
  },
  {
    ...
    faqs: [
      {
        q: '標準的な納期はどのくらいですか？',
        a: 'ご入金確認後15〜30営業日（目安3〜4週間・土日祝除く）が標準納期です。特急オプションを選択すると12営業日以内（目安2〜3週間）に短縮できます。工場の混雑状況によって変動する場合があります。',
      },
      {
        q: '特急・短納期対応はできますか？',
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: '型代は2回目以降も必要ですか？',
        a: '同じ形状・サイズで再注文する場合、型の再利用が可能です。注文時に前回の注文番号を入力することで型代が免除されます。型は最終注文日から1年間保管しており、1年以内の再注文であれば型代不要です。形状やサイズを変更する場合は新たに型代が発生します。',
      },
      {
