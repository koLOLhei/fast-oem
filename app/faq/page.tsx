...
const faqCategories = [
  {
    ...
    faqs: [
      {
        q: '最低注文数はいくつですか？',
        a: '商品によって異なります。アクリルキーホルダー・ピンバッジ・ラバーキーホルダーは50個〜、缶バッジは30個〜、レジ袋は500枚〜からご注文いただけます。小ロットから大量発注まで対応しております。',
      },
      {
        q: '注文数の上限はありますか？',
  ...
  },
  {
    ...
    faqs: [
      {
        q: '標準的な納期はどのくらいですか？',
        a: '商品・数量により異なりますが、ご入金確認後14〜30営業日程度が目安です（土日祝除く）。アクリルキーホルダー・缶バッジは14〜21営業日、ピンバッジ・ラバーキーホルダー・レジ袋は21〜30営業日が標準です。工場の混雑状況によって変動する場合があります。',
      },
      {
        q: '特急・短納期対応はできますか？',
        a: 'はい、全商品に特急オプション（約10営業日）をご用意しております。商品詳細ページで「特急配送」を選択すると別途特急料金が加算されます。工場の空き状況により対応できない場合もありますので、お急ぎの場合はお早めにご注文ください。',
      },
      {
        q: '送料はいくらですか？',
        a: '日本国内の通常地域（本州・北海道・四国・九州の大部分）は送料無料です。離島・沖縄・一部の遠隔地は別途送料が発生します。送料はチェックアウト時に配送先住所を入力すると自動で計算されます。海外への配送は現在対応しておりません。',
      },
      {
        q: '配送状況を確認できますか？',
