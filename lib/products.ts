...
export const PRODUCTS: Product[] = [
  {
    ...
    priceTiers: [
      ...
      { minQuantity: 30, maxQuantity: 49, unitPrice: 300, discountPercent: 14 },
      { minQuantity: 50, maxQuantity: 99, unitPrice: 260, discountPercent: 26 },
      { minQuantity: 100, maxQuantity: 199, unitPrice: 220, discountPercent: 37 },
      { minQuantity: 200, maxQuantity: 299, unitPrice: 190, discountPercent: 46 },
      { minQuantity: 300, maxQuantity: 499, unitPrice: 170, discountPercent: 51 },
      { minQuantity: 500, maxQuantity: 1000, unitPrice: 150, discountPercent: 57 },
    ],
    options: [
      {
        id: 'shape',
      ...
      },
      {
        ...
        values: [
          { id: '30mm', label: '30mm' },
          { id: '40mm', label: '40mm', priceModifier: { type: 'add', value: 10 } },
          { id: '50mm', label: '50mm', priceModifier: { type: 'add', value: 20 } },
          { id: '60mm', label: '60mm', priceModifier: { type: 'add', value: 35 } },
          { id: '70mm', label: '70mm', priceModifier: { type: 'add', value: 50 } },
          { id: '80mm', label: '80mm', priceModifier: { type: 'add', value: 65 } },
          { id: '90mm', label: '90mm', priceModifier: { type: 'add', value: 80 } },
          { id: '100mm', label: '100mm', priceModifier: { type: 'add', value: 100 } },
          { id: '120mm', label: '120mm', priceModifier: { type: 'add', value: 130 } },
    ...
    quantityPresets: [10, 30, 50, 100, 200, 300, 500, 1000],
  },
  {
    id: 'can-badge',
    slug: 'can-badge',
  ...
  },
  {
    ...
    moldFee: 15000,
    priceTiers: [
      { minQuantity: 30, maxQuantity: 49, unitPrice: 450 },
      { minQuantity: 50, maxQuantity: 99, unitPrice: 380, discountPercent: 16 },
      { minQuantity: 100, maxQuantity: 199, unitPrice: 320, discountPercent: 29 },
      { minQuantity: 200, maxQuantity: 299, unitPrice: 280, discountPercent: 38 },
      { minQuantity: 300, maxQuantity: 499, unitPrice: 250, discountPercent: 44 },
      { minQuantity: 500, maxQuantity: 999, unitPrice: 220, discountPercent: 51 },
      { minQuantity: 1000, maxQuantity: 2000, unitPrice: 190, discountPercent: 58 },
    ],
    options: [
      {
        id: 'shape',
      ...
      },
      {
        ...
        values: [
          { id: '15mm', label: '15mm' },
          { id: '20mm', label: '20mm', priceModifier: { type: 'add', value: 20 } },
          { id: '25mm', label: '25mm', priceModifier: { type: 'add', value: 40 } },
          { id: '30mm', label: '30mm', priceModifier: { type: 'add', value: 60 } },
          { id: '35mm', label: '35mm', priceModifier: { type: 'add', value: 80 } },
          { id: '40mm', label: '40mm', priceModifier: { type: 'add', value: 100 } },
          { id: '45mm', label: '45mm', priceModifier: { type: 'add', value: 120 } },
          { id: '50mm', label: '50mm', priceModifier: { type: 'add', value: 150 } },
          { id: 'custom', label: 'サイズを指定' },
        ],
      },
      {
  ...
  },
  {
    ...
    priceTiers: [
      ...
      { minQuantity: 50, maxQuantity: 99, unitPrice: 320, discountPercent: 16 },
      { minQuantity: 100, maxQuantity: 199, unitPrice: 280, discountPercent: 26 },
      { minQuantity: 200, maxQuantity: 299, unitPrice: 250, discountPercent: 34 },
      { minQuantity: 300, maxQuantity: 499, unitPrice: 220, discountPercent: 42 },
      { minQuantity: 500, maxQuantity: 999, unitPrice: 190, discountPercent: 50 },
      { minQuantity: 1000, maxQuantity: 2000, unitPrice: 160, discountPercent: 58 },
    ],
    options: [
      {
        id: 'shape',
      ...
      },
      {
        ...
        values: [
          { id: '30mm', label: '30mm' },
          { id: '40mm', label: '40mm', priceModifier: { type: 'add', value: 20 } },
          { id: '50mm', label: '50mm', priceModifier: { type: 'add', value: 40 } },
          { id: '60mm', label: '60mm', priceModifier: { type: 'add', value: 60 } },
          { id: '70mm', label: '70mm', priceModifier: { type: 'add', value: 80 } },
          { id: '80mm', label: '80mm', priceModifier: { type: 'add', value: 100 } },
          { id: '90mm', label: '90mm', priceModifier: { type: 'add', value: 130 } },
          { id: '100mm', label: '100mm', priceModifier: { type: 'add', value: 160 } },
          { id: 'custom', label: 'サイズを指定' },
        ],
      },
      {
