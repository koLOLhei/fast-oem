...
export const PRODUCTS: Product[] = [
  {
    ...
    priceTiers: [
      { minQuantity: 50, maxQuantity: 100, unitPrice: 69 },
      { minQuantity: 101, maxQuantity: 200, unitPrice: 67, discountPercent: 3 },
      { minQuantity: 201, maxQuantity: 300, unitPrice: 64, discountPercent: 7 },
      { minQuantity: 301, maxQuantity: 500, unitPrice: 62, discountPercent: 10 },
      { minQuantity: 501, maxQuantity: 1000, unitPrice: 60, discountPercent: 13 },
      { minQuantity: 1001, maxQuantity: 2000, unitPrice: 58, discountPercent: 16 },
      { minQuantity: 2001, maxQuantity: 3000, unitPrice: 55, discountPercent: 20 },
      { minQuantity: 3001, maxQuantity: 5000, unitPrice: 52, discountPercent: 25 },
      { minQuantity: 5001, maxQuantity: 10000, unitPrice: 49, discountPercent: 29 },
  ...
  },
  {
    ...
    expressDeliveryFee: 0,
    priceTiers: [
      { minQuantity: 100, maxQuantity: 199, unitPrice: 114 },
      { minQuantity: 200, maxQuantity: 299, unitPrice: 97, discountPercent: 15 },
      { minQuantity: 300, maxQuantity: 499, unitPrice: 78, discountPercent: 32 },
      { minQuantity: 500, maxQuantity: 999, unitPrice: 51, discountPercent: 55 },
      { minQuantity: 1000, maxQuantity: 2999, unitPrice: 29, discountPercent: 75 },
      { minQuantity: 3000, maxQuantity: 4999, unitPrice: 15, discountPercent: 87 },
      { minQuantity: 5000, maxQuantity: 9999, unitPrice: 12, discountPercent: 89 },
      { minQuantity: 10000, maxQuantity: 19999, unitPrice: 9, discountPercent: 92 },
      { minQuantity: 20000, maxQuantity: 29999, unitPrice: 8, discountPercent: 93 },
      { minQuantity: 30000, maxQuantity: 99999, unitPrice: 8, discountPercent: 93 },
      { minQuantity: 100000, maxQuantity: 200000, unitPrice: 8, discountPercent: 93 },
    ],
    options: [
      {
        id: 'background_color',
  ...
  },
  {
    ...
    priceTiers: [
      ...
      { minQuantity: 101, maxQuantity: 200, unitPrice: 56, discountPercent: 7 },
      { minQuantity: 201, maxQuantity: 300, unitPrice: 55, discountPercent: 8 },
      ...
      { minQuantity: 1001, maxQuantity: 2000, unitPrice: 51, discountPercent: 15 },
      { minQuantity: 2001, maxQuantity: 3000, unitPrice: 51, discountPercent: 15 },
      { minQuantity: 3001, maxQuantity: 5000, unitPrice: 49, discountPercent: 18 },
      { minQuantity: 5001, maxQuantity: 10000, unitPrice: 48, discountPercent: 20 },
  ...
  },
  {
    ...
    expressDeliveryFee: 0,
    priceTiers: [
      { minQuantity: 50, maxQuantity: 100, unitPrice: 67 },
      { minQuantity: 101, maxQuantity: 200, unitPrice: 64, discountPercent: 4 },
      { minQuantity: 201, maxQuantity: 300, unitPrice: 62, discountPercent: 7 },
      { minQuantity: 301, maxQuantity: 500, unitPrice: 60, discountPercent: 10 },
      { minQuantity: 501, maxQuantity: 1000, unitPrice: 58, discountPercent: 13 },
      { minQuantity: 1001, maxQuantity: 2000, unitPrice: 55, discountPercent: 18 },
      { minQuantity: 2001, maxQuantity: 3000, unitPrice: 52, discountPercent: 22 },
      { minQuantity: 3001, maxQuantity: 5000, unitPrice: 49, discountPercent: 27 },
      { minQuantity: 5001, maxQuantity: 10000, unitPrice: 47, discountPercent: 30 },
